...
namespace ARES
{
    public static class Display
    {
        ...
        public static void FlashSelection(Position pixelPos, ILayer activeLayer, int IntervalOfFlashing = 500)
        {
            ArcMap.Document.ActiveView.Refresh();
        ...
        private static IElement DrawBoxElement(ISimpleFillSymbol boxSymbol, Position pixelPos, ILayer activeLayer)
        {
            ILayer layer = activeLayer;
